...
public interface IAdminService {
    boolean saveOrUpdatePerformance(Integer performanceId, String name, String shortDescription,
                                    String description, Calendar date1, Calendar date2, String image, Category category,
                                    Set<TicketsPrice> ticketsPrices, Integer langId) throws ServiceException;
